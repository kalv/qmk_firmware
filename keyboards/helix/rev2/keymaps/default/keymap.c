...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl| Esc  | Alt  | GUI  | Lower | Space |Adjust |Space |Space | Raise| Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,  KC_ESC,  KC_LALT, KC_LGUI, LOWER,    KC_LGUI,   ADJUST,  KC_SPC,  KC_SPC,   RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
